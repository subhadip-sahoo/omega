<?php /* Template Name: Responsibility */ ?>
<?php get_header(); ?>
    ...
    <section class="wrapper clearfix">
        <article class="page-container clearfix">
            ...
            <div class="page-text clearfix">
                <?php query_posts(array('post_type' => 'responsibility', 'posts_per_page' => -1)); ?>
                <?php if(have_posts()): ?>
                <div class="grid-row careers-grid">
                    ...
                    <?php endwhile; ?>
                    <?php wp_reset_query(); ?>
                    <?php if($post_id = get_career_search_page('responsibility')) : ?>
                    <!-- <div class="grid-row6 search-carrer-grid">
                        <div class="grid-row-block">
                            <h4 class="who-are-grid-title"><?php echo get_the_title($post_id); ?></h4>
                            <a href="<?php echo get_permalink(get_career_search_page('responsibility')); ?>">
